...
from ...services import ac_client
from ...core.constitutional_prompting import constitutional_prompter
from ...core.llm_integration import llm_client
...
async def ec_constitutional_prompting(
    ...
    try:
        ...
        llm_response = await llm_client.generate_constitutional_guidance(
            prompt=guidance_prompt,
            context="evolutionary_computation_governance"
        )
        
        # Step 5: Parse LLM response and extract structured guidance
        structured_guidance = _parse_ec_constitutional_guidance(llm_response)
        ...
        response = gs_schemas.ECConstitutionalPromptingOutput(
            ...
            synthesis_metadata={
                ...
                "llm_model": llm_client.get_model_info(),
