...
from auth_service.app.api.endpoints import router as api_router
from auth_service.app.db.database import create_db_tables, engine
from fastapi_csrf_protect import CsrfProtect
from fastapi_csrf_protect.exceptions import CsrfProtectError
from pydantic_settings import BaseSettings
import os
from shared.security_middleware import add_security_headers
from auth_service.app.core.limiter import limiter, RateLimitExceeded, _rate_limit_exceeded_handler # Import limiter components
